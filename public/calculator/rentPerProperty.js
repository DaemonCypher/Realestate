function calculateAverageRent() {
    // Get the values from the input fields
    var totalRentCollected = document.getElementById('totalRentCollected').value;
    var numberRentedUnits = document.getElementById('numberRentedUnits').value;
    ...
    // Display the result
    var resultDiv = document.getElementById('resultAverageRent');
